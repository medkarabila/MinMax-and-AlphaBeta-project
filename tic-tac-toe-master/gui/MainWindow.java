...
public class MainWindow extends JFrame {
  ...
  public MainWindow() {
    ...
    titleGaloImage = new ImageIcon(getClass().getResource("/images/titlegalo.png"));

    titleGaloLabel = new JLabel(titleGaloImage);
    titleGaloLabel.setPreferredSize(new Dimension(500, 300));
    titleGaloLabel.setBackground(java.awt.Color.PINK);

    startButton = new JButton("Nouveau jeu");
    startButton.setBackground(java.awt.Color.PINK);
