...
public class ControlBoard extends JFrame {
  ...
  public ControlBoard(Board mainboard) {
    ...
    hideConsole = new JButton("Reduire la console");
    ...
    hideConsole.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        if (statusPanel.isVisible()) {
          ...
          hideConsole.setText("Afficher la console");
          setSize(405, 450);
        } else {
          statusPanel.setVisible(true);
          hideConsole.setText("Réduire la console");
          setSize(650, 450);
        }
      }
    });
    ...
    if (mainBoard.getIsComputer()) {
      if (mainBoard.getIsMinMax()) {
        System.out
            .println("L'algorithme min-Max");
        System.out.println("");
      } else {
        System.out
            .println("L'algorithme min-Max avec élagage alpha-Beta");
        System.out.println("");
      }
      if (mainBoard.getIsPlayerFirst()) {
        System.out.println(mainBoard.getTurn() + " Humain");
      }

    } else if (mainBoard.getIsPlayerFirst()) {
      System.out.println(mainBoard.getTurn() + " Joueur 1");
      System.out.println(mainBoard.getPlayLeft() + " Pas pour atteindre la fin");
    } else {
      System.out.println(mainBoard.getTurn() + " Joueur 2");
      System.out.println(mainBoard.getPlayLeft() + " Pas pour atteindre la fin");
    }
  }
}
